...
namespace MonoProject.DAL.Data
{
    public class VehicleDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VehicleModelToVehicleOwnerLink>().HasOne(m => m.VehicleModel).WithMany(o => o.VehicleModelToVehicleOwnerLinks).HasForeignKey(x => x.ModelId);
            modelBuilder.Entity<VehicleModelToVehicleOwnerLink>().HasOne(m => m.VehicleOwner).WithMany(o => o.VehicleModelToVehicleOwnerLinks).HasForeignKey(x => x.OwnerId);
            modelBuilder.Entity<VehicleRegistration>().HasOne(m => m.vehicleModelToVehicleOwnerLink).WithOne(o => o.VehicleRegistration).HasForeignKey<VehicleModelToVehicleOwnerLink>(x => x.RegistrationId);
